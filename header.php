...
<link rel="stylesheet" href="<?php echo get_stylesheet_uri(); ?>?20180524">
...
<body <?php body_class(); ?>>
				...
				<div class="header__right flexbox flex_v-center">
					...
					<a href="<?php echo get_template_directory_uri(); ?>/toppage_en/">
						<div class="header__btn btn btn--simple">
							<span class="font_a5a5a5">日本語</span>/ ENGLISH
						</div>
					</a>
		...
		<div class="nav__wrap">
			<nav class="nav">
				<ul class="nav__inner">
					<li class="nav__item arrow-right arrow--white nav__item__home">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>">HOME</a>
					</li>
					<li class="nav__item arrow-right arrow--white">
						<a href="<?php echo get_template_directory_uri(); ?>/party/">結婚式２次会
							<br class="txt-br">・各種パーティー
						</a>
					</li>
					<li class="nav__item arrow-right arrow--white">
						<a href="<?php echo get_template_directory_uri(); ?>/kamakura/">ロケーション撮影</a>
					</li>
					<li class="nav__item arrow-right arrow--white">
						<a href="<?php echo get_template_directory_uri(); ?>/flower/">花の写真教室</a>
					</li>
					<li class="nav__item arrow-right arrow--white">
						<a href="<?php echo get_template_directory_uri(); ?>/blog/">BLOG</a>
					</li>
					<li class="nav__item arrow-right arrow--white">
						<a href="<?php echo get_template_directory_uri(); ?>/fee/">料金について</a>
					</li>
					<li class="nav__item arrow-right arrow--white">
						<a href="<?php echo get_template_directory_uri(); ?>/contact/">お申込み・
							<br class="txt-br">お問い合わせ
						</a>
					</li>
				</ul>
			</nav>
